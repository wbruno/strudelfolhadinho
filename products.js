exports.products = {
  sweet: {
    maca: {
      ...
      price: '100,00', url: '/strudel-de-maca.html'
    },
    leite: {
    ...
    mini: {
      name: 'Mini Strudel de Banana', description: 'Todo o sabor do Strudel de Banana em tamanho mini, individual',
